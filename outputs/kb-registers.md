...
| `Raw/22910 FISHBONE.pdf` | 2026-09-10 | pending | none yet | Software quote/contract (Offer Nr 22910, dated 10/09/2026) from Kosmosoft Engineering S.r.l. for "SmartCABINET" CAD/CAM/ERP software, addressed to "Fishbone Drylining Ltd" (the pre-2024 company name). Uploaded directly to `Raw/` (Xerox scan), not via email. OCR is noisy on the pricing lines - three lines read "1.000,00" (EUR), uncertain whether three line items or a duplication artefact; not re-read as a rasterised image. Not written into the Wiki and not registered in the group Document Register: price is uncertain and whether to proceed is the owner's decision, not this KB's to assume. See `Outputs/change-log-2026-09-10-v1.3-and-kosmosoft-quote.md`. |
