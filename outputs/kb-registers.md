...
| `Raw/22910 FISHBONE.pdf` | 2026-09-10 | done | Suppliers/kosmosoft-smartcabinet | Software quote/contract (Offer Nr 22910, dated 10/09/2026) from Kosmosoft Engineering S.r.l. for "SmartCABINET" CAD/CAM/ERP software, addressed to "Fishbone Drylining Ltd" (the pre-2024 company name). Uploaded directly to `Raw/` (Xerox scan), not via email. **Confirmed paid by the owner 2026-09-10** - see `Raw/2026-09-10_owner-note_kosmosoft-22910-paid.md`. Registered locally as `FCD0000024`. Exact price still unresolved: OCR is noisy on the pricing lines - three lines read "1.000,00" (EUR), uncertain whether three line items or a duplication artefact; not re-read as a rasterised image - open question on the Wiki article. Not registered in the group Document Register: not instructed, and general software purchases sit outside the policy's plainly-listed registrable categories. See `Outputs/change-log-2026-09-10-kosmosoft-confirmed-paid.md`. |
