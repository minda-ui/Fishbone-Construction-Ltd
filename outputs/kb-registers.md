...
| Date | Entry | File |
|---|---|---|
| 2026-09-11 | Raw/Finance checked; new RT_ export found, reconciled, registered pending (partial period, not yet in Wiki) | `Outputs/change-log-2026-09-11-finance-rt-export-check.md` |
| 2026-09-11 | Kosmosoft SmartCABINET quote price confirmed by the owner at EUR 1,000; Wiki article and FCD0000024 updated | `Outputs/change-log-2026-09-11-kosmosoft-price-confirmed.md` |
| 2026-09-10 | Kosmosoft SmartCABINET quote confirmed paid by the owner; registered locally as FCD0000024; Wiki article created | `Outputs/change-log-2026-09-10-kosmosoft-confirmed-paid.md` |
| 2026-09-10 | Group policy v1.3 adopted (property codes n/a, email-attachment transcription pattern); Kosmosoft SmartCABINET quote detected and registered pending; CLAUDE.md replaced by v10 | `Outputs/change-log-2026-09-10-v1.3-and-kosmosoft-quote.md` |
| 2026-09-09 | Group policy v1.2 adopted; FC-CR-0001 resolved (Accepted); no back-catalogue left to migrate; CLAUDE.md replaced by v9 | `Outputs/change-log-2026-09-09-v1.2-adopted.md` |
| 2026-09-09 | Rest of local FCD back-catalogue: change request FC-CR-0001 raised with the group, not migrated | `Outputs/change-log-2026-09-09-back-catalogue-change-request-raised.md` |
...
| `Raw/2026-09-09_group-policy_document-numbering-and-filing-v1.1.md` | 2026-09-09 | skipped | Processes/group-document-numbering-and-filing, Decisions/2026-09-09-group-document-numbering-policy-adopted | Group-wide policy notice from the Fishbone Group knowledge base (not a business document - explicitly marked "do not register on the Document Register"). **Adopted 2026-09-09** at the owner's instruction: rules written up in the two Wiki articles named, `CLAUDE.md` §1 gets one pointer row. Establishes a single cross-entity Document Register (Smartsheet, sheet id `7352854736144260`) with 7-digit per-entity-prefixed IDs (`FC` for Construction), running alongside - not replacing - the existing local `FCT`/`FCD` numbering, whose back-catalogue migration is the group's own follow-on. **Read and write access both confirmed 2026-09-09** (write via a scripted add-then-delete test row, immediately removed). **First real registration also 2026-09-09: FC0000001**, the MSEM court claim's Claim form. Left in place in `Raw/`, not moved - see the Decisions article. **2026-09-09, later: the owner asked to migrate the rest of the local FCD back-catalogue (FCD0000001-FCD0000014) too. Not migrated** - those 14 rows are task/email pointers (Gmail links, no stored file, unverified attachments), not documents; raised as `FC-CR-0001` on the group's Change Requests sheet instead. See `Outputs/change-log-2026-09-09-back-catalogue-change-request-raised.md`. **Superseded by v1.2 below.** |
| `Raw/2026-09-09_group-policy_document-numbering-and-filing-v1.2.md` | 2026-09-09 | skipped | Processes/group-document-numbering-and-filing, Decisions/2026-09-09-group-document-numbering-policy-adopted | Found on a `/Raw` check requested by the owner - the group's response to `FC-CR-0001`, delivered at 21:46. **`FC-CR-0001` resolved: Accepted** (the group had already updated the Change Requests row itself - Status, Resolution, Reviewed date - before this check). Two clarifications, both now in the policy: (1) tasks/email-tracking rows with no verified business record are never registered (§6) - confirms `FCD0000001`-`FCD0000014` correctly stay local; (2) each KB may migrate its own back-catalogue whenever ready, deduping on entry (§11) - no longer group-run-only. Net effect here: nothing is left to migrate - all 23 local `FCD` rows are accounted for (9 as `FC0000001`-`FC0000009`, 14 correctly excluded as tasks). Left in place in `Raw/`, not moved, alongside the v1.1 notice - see the Decisions article. **Superseded by v1.3 below.** See `Outputs/change-log-2026-09-09-v1.2-adopted.md`. |
| `Raw/2026-09-10_group-policy_document-numbering-and-filing-v1.3.md` | 2026-09-10 | skipped | Processes/group-document-numbering-and-filing, Decisions/2026-09-09-group-document-numbering-policy-adopted | Found on a `/Raw` check requested by the owner. Resolves two *other* companies' change requests (`FM-CR-0001` Commercial Properties, `FP-CR-0001` Properties, both Accepted 2026-09-10) - not this KB's. Two clarifications: (1) self-assigned 4-digit property codes (§3/§7) - **not applicable**, this KB owns no property; (2) email-attachment transcription pattern using Gmail thread id + flagged plain-text transcription (§5) - **directly relevant**, matches the unfiled-attachment gap the info-mailbox pipeline has carried since 2026-09-06, though not yet applied to the existing backlog. Adopted 2026-09-10. Left in place in `Raw/`, not moved, alongside v1.1/v1.2 - see the Decisions article. See `Outputs/change-log-2026-09-10-v1.3-and-kosmosoft-quote.md`. |
| `Raw/22910 FISHBONE.pdf` | 2026-09-10 | done | Suppliers/kosmosoft-smartcabinet | Software quote/contract (Offer Nr 22910, dated 10/09/2026) from Kosmosoft Engineering S.r.l. for "SmartCABINET" CAD/CAM/ERP software, addressed to "Fishbone Drylining Ltd" (the pre-2024 company name). Uploaded directly to `Raw/` (Xerox scan), not via email. **Confirmed paid by the owner 2026-09-10; price confirmed 2026-09-11 at EUR 1,000** - see `Raw/2026-09-10_owner-note_kosmosoft-22910-paid.md` and `Raw/2026-09-11_owner-note_kosmosoft-22910-price-confirmed.md`. Registered locally as `FCD0000024` (description updated 2026-09-11 with the confirmed price). Not registered in the group Document Register: not instructed, and general software purchases sit outside the policy's plainly-listed registrable categories. See `Outputs/change-log-2026-09-11-kosmosoft-price-confirmed.md`. |
| `Raw/2026-09-10_owner-note_kosmosoft-22910-paid.md` | 2026-09-10 | done | Suppliers/kosmosoft-smartcabinet | Owner (Minda) verbal statement written up by the assistant: the Kosmosoft 22910 quote is already paid. Answers whether the company proceeded with the purchase; does not state the amount. See `Outputs/change-log-2026-09-10-kosmosoft-confirmed-paid.md`. |
| `Raw/2026-09-11_owner-note_kosmosoft-22910-price-confirmed.md` | 2026-09-11 | done | Suppliers/kosmosoft-smartcabinet | Owner (Minda) verbal statement written up by the assistant: the Kosmosoft 22910 price is EUR 1,000, resolving the OCR ambiguity (three lines reading "1.000,00") in favour of the single-figure reading. See `Outputs/change-log-2026-09-11-kosmosoft-price-confirmed.md`. |
...
| `Raw/Finance/RT_20260911_04212819.csv` | 2026-09-11 | pending | none yet | **Different in kind from the six statements above**: named `RT_` (Recent Transactions, not the `YYYYMMDD_04212819` monthly-close naming), and a different column layout (`Date,Type,Description,Amount,Balance` - one signed Amount column - instead of `Paid Out,Paid In,Balance`). Covers 12 Aug to 11 Sep 2026, newest-first. Reconciled: running balance arithmetic checks out exactly across all 217 transaction pairs (0 mismatches), and its 21 Aug 2026 closing balance (£5,867.23) matches the prior statement's closing balance exactly, confirming continuity. Rows 12-21 Aug duplicate `20260821_04212819.csv` (already `done`); **rows 22 Aug-11 Sep are new**, but only a partial period - the next full monthly cycle (22 Aug-21 Sep) has not yet closed. Not reconciled into the Wiki Finance/Customer articles pending either the closing statement or an explicit instruction to process a partial period. Notable transactions found (not yet written up): a debit dated 10 Sep referencing "22910" and Kosmosoft Srl, -£878.03, which converts to almost exactly EUR 1,000 at the FX rate shown in the transaction reference - independently confirms the price the owner stated for `Raw/22910 FISHBONE.pdf` (see `Wiki/Suppliers/kosmosoft-smartcabinet.md`); Macdonald Joinery credits continuing (21 Aug £1,360; 28 Aug £2,920; 4 Sep £3,000; 11 Sep £6,144 - the largest single credit from that customer since the May 2026 fall). See `Outputs/change-log-2026-09-11-finance-rt-export-check.md`. |
...
| 2026-09-09 | Both Wiki articles above updated once more (back-catalogue change request recorded); `CLAUDE.md` not touched (no live-data-sources claim needed updating) | Owner instruction to migrate the rest of the local `FCD` back-catalogue; found to be task/email pointers, not documents - raised as `FC-CR-0001` with the group instead of migrating |
| 2026-09-09 | Both Wiki articles above updated once more (v1.2 adopted, `FC-CR-0001` resolution recorded); `CLAUDE.md` replaced by v9 (live-data-sources table corrected to v1.2) | Owner asked to check `/Raw`; found the group's v1.2 policy notice resolving `FC-CR-0001` as Accepted - tasks never register (§6), each KB may self-migrate (§11); nothing left to migrate for this KB |
| 2026-09-10 | Both Wiki articles above updated once more (v1.3 adopted); `CLAUDE.md` replaced by v10 (live-data-sources table corrected to v1.3) | Owner asked to check `/Raw`; found the group's v1.3 policy notice (property codes n/a here; email-attachment transcription pattern relevant to the info-mailbox gap) and a new Kosmosoft SmartCABINET quote (registered `pending`, not yet written up - price uncertain from OCR, purchase decision is the owner's) |
| 2026-09-10 | Created `Wiki/Suppliers/kosmosoft-smartcabinet.md`; `Wiki/index.md` re-issued to list it | Owner confirmed the Kosmosoft 22910 quote is already paid; document moved from `pending` to `done`, registered locally as `FCD0000024`; exact price kept as an open question rather than guessed |
| 2026-09-11 | `Wiki/Suppliers/kosmosoft-smartcabinet.md` updated (price open question answered, retracted in place per §6d rule 2) | Owner stated the Kosmosoft 22910 price is EUR 1,000; local Document Register row `FCD0000024` description also updated |
