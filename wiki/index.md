...
- [Anna (AI Construction Assistant) authorised to write here](Decisions/2026-09-22-anna-construction-adviser-write-access.md) - what Anna may and may not write in this KB, the bars that stay, and why Drive shows no separation between her edits and the owner's
...
- [Group document numbering and filing (policy v1.3)](Processes/group-document-numbering-and-filing.md) - the cross-company Document Register, its `FC` prefix, dedup-on-entry, and the inter-KB hand-off procedure
